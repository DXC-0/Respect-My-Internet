...
rm -rf /etc/opensnitchd/blocklist/respect-my-internet.txt
rm -rf /etc/opensnitchd/ip/ip-protection.txt
curl https://raw.githubusercontent.com/TheCyberArcher/Respect-My-Internet/refs/heads/main/blocklist/respect-my-internet.txt >> /etc/opensnitchd/blocklist/respect-my-internet.txt
